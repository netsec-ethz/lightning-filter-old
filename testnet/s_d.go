...
func runServer(daemonAddr, dispatcherSocket string, localAddr snet.UDPAddr, dataCallback func(data string)) {
	var err error
...
func main() {
	...
	runServer(daemonAddr, dispatcherSocket, localAddr, nil)
}
