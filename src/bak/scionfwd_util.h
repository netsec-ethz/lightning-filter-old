...
#define ETH_HDR(m) (struct rte_ether_hdr *)(rte_pktmbuf_mtod((m), uint8_t *))
#define IPV4_HDR(m) (struct rte_ipv4_hdr *)(ETH_HDR(m) + 1)
#define UDP_HDR(m) (struct rte_udp_hdr *)(IPV4_HDR(m) + 1)
